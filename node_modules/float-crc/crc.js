...
* @Last Modified by:   xl
* @Last Modified time: 2015-10-22 23:47:10
*/
module.exports = function (float) {
    ...
    function get_float_hex(decString) {
        ...
        var unSortedResult = parseInt(signString + exponentString + fractionString, 2).toString(16);
        return [Number('0x' + unSortedResult.slice(-2)), Number('0x' + unSortedResult.slice(-4, -2)), Number('0x' + unSortedResult.slice(2, 4)), Number('0x' + unSortedResult.slice(0, 2))];
    }

    return get_float_hex(float);
}
